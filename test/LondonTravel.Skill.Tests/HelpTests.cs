...
{
    public class HelpTests : FunctionTests
    {
        public HelpTests(ITestOutputHelper outputHelper)
            : base(outputHelper)
        {
        }
